...
We're glad you want to help! Inkframe is built to be simple, fast, and easy to read.

## Organic Code Quality

We prioritize code that is clean, readable, and organic. Whether you write it by hand or use tools (including AI) to help, the end result should look like it was thoughtfully crafted by a human for other humans to read. Avoid over-templated boilerplate or rigid, machine-like patterns that add unnecessary complexity.
